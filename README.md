...
3. **Cache Line Size**:
   - Όσον αφορά το κόστος, ο μεγαλύτερος cache line size αυξάνει την καθυστέρηση της cache και την κατανάλωση bandwidth.
   - Για την απόδοση, μεγαλύτερα cache lines είναι καλύτερα για προγράμματα με υψηλή χωρική τοπικότητα, αλλά μπορούν να οδηγήσουν σε αυξημένο waste αν τα δεδομένα δεν χρησιμοποιούνται.
...
- **Συντελεστές Βαρύτητας**:
  - Αντιπροσωπεύουν το κόστος ανά μονάδα κάθε παράγωντα. Επείδη μας ζητήτε να δώσουμε τιμές αυθαίρετα , θα δώσω τις τιμες:
  ...
  - w3 = w4 = 0.5 (Associativity επηρεάζει λιγότερο το κόστος και την πολυπλοκότητα του κυκλώματος).
  - w5 = 0.2 (Cacheline Size λόγω επιπτώσεων στη μνήμη και bandwidth).
