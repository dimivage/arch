...
Για να περιορίσω τη δοκιμή, χρησιμοποίησα τις εξής στρατηγικές:
...
*Ο πίνακας περιέχει και άλλες περιπτώσεις, ανατρέξτε στο συνοδευτικό αρχείο Excel για όλα τα δεδομένα.*
